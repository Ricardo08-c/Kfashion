...
function Facturacion1() {
 ...
 async function onSubmit(e) {
   ...
   await fetch("https://moticaserver.onrender.com/add/user", {    
     method: "POST",
     headers: {
   ...
   setForm({ nombre: "", apellido: "" ,fecha_nacimiento:"",correo:"", contrasenha:"",cedula:"",sexo:"M",rol:"EMP"});
   navigate("/");
 }
 ...
 return (
   <div  className= "position-relative alineadoCentroNonRel" style = {{minHeight:"100%",maxWidth:"30%"}}>
     ...
     <form onSubmit={onSubmit}>
       ...
       <div className="form-group" style = {{display:"inline-block"}}>
         <label className= "text-white"htmlFor="name">Apellido</label>
         <input
           type="text"
           className="form-control"
           id="name"
       ...
       <div className="form-group" >
         <label className= "text-white"htmlFor="name">Cédula</label>
         <input
           type="text"
           className="form-control"
           id="name"
       ...
       <div className="  form-group">
         <label className= "text-white"htmlFor="name">Fecha de Nacimiento</label>
         <input type='date'  className="form-control"
           id="name"
           value={form.fecha_nacimiento}
           onChange={(e) => updateForm({ fecha_nacimiento: e.target.value })} class="form-control" />
       </div>
       <div className="form-group">
        
         <label className= "text-white"htmlFor="name">Sexo</label>
       ...
       <li>----</li>
       <h4 className= "text-success"htmlFor="name" style = {{left:"10%"}}>Información para la cuenta </h4>
       <div className="form-group">
       ...
       <div className="form-group">
         <label className= "text-white"htmlFor="name">Contraseña</label>
         <input
           type="text"
           className="form-control"
           id="name"
       ...
       <div className="form-group">
         <label className= "text-white"htmlFor="name">Rol</label>
       ...
       <br></br>
       <button className= "btn text-white btn-outline-secondary" onClick= {onSubmit}>Registrar</button>
     </form>
   </div>
 );
}
...
<Plantilla sectionToDisplay = {Facturacion1()}></Plantilla>
